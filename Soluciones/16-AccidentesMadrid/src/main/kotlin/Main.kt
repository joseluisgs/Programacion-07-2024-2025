...
import dev.joseluisgs.services.AccidentesService

fun main() {
    println("Accidentes Madrid DAW - Kotlin Edition")
    val service = AccidentesService()
    val accidentes = service.getAll()
